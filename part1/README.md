...
The total cost dropped to 108691.43. Most of the decrease came from taking advantages of index when joining, as you can see on the figure below.
...
The total cost dropped to 6763992.34. Most of the decrease came from taking advantages of index when joining, as you can see on the figure below.
...
Here is what we got after optimization (figure below), and the cost of our query is now : 12899075.
